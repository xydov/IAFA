...
| IF condition THEN statement elseStatement END
		{IF_THEN($2, $4, $5)}
;
...
elseStatement:
	ELSE statement
		{$2}
| ELSEIF condition THEN statement elseStatement_T
		{IF_THEN($2, $4, $5)}
| {NOP}
;
...
conditionT:
	conditionT AND condition
		{AND($1, $3)}
|	RBRACKET condition LBRACKET
		{$1}
;
